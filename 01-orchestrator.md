...
- Finite context → graceful **reset/handoff**: park/finish open tasks, document, commit, write
  `handoff.md`, then continue.
...
## The macro-loop **[OPEN — partly specced]**
Core known: roadmap → execute → test → document → audit → next. Incomplete: research, debug, and more
phases exist; checkpoint + reset must be slotted in.
